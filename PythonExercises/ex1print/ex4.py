...
print("Hola gtrqjska (nombre de alienijena (mujer)) hay", Naves_ocupadas, "naves ocupadas creo que no nos alcanzan sitios quedan porque quedan", Gente_en_cola, "personas esperando.")
